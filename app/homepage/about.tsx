...
const About = () => {
  return (
    <div className="h-screen w-screen border-b-4  flex flex-col justify-between ">
      ...
      <div className="h-1/2 bg-purpleprimary grid grid-cols-3 text-white ">
        <div className="border-r-4 border-black flex flex-col gap-2 items-center justify-center">
