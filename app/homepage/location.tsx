...
const Location = () => {
  ...
  return (
    <section className=" min-h-[90vh] sm:max-h-[90vh] w-screen bg-redprimary p-8 sm:p-12 border-b-4">
      <h1 className="text-4xl text-white pb-20">Miejsce wydarzenia</h1>
      <div className="flex flex-col sm:grid grid-cols-2 gap-10 h-2/3">
        <div className="bg-white h-[50vh] drop-shadow-big border-4 p-12 flex flex-col gap-12">
          {" "}
