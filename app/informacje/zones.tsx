...
const Zones = () => {
  return (
    <section className="min-h-[90vh] sm:max-h-[90vh] sm:h-[90vh] bg-[url('/zamora.jpg')] bg-cover bg-center bg-fixed  w-screen border-b-4 p-8 sm:p-12 ">
      <h1 className="text-6xl pb-20 text-white">Strefy wydarzenia</h1>
