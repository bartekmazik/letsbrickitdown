...
const Organisator = ({
  ...
  return (
    <div className="h-[60vh] bg-white w-full drop-shadow-small text-black border-4 border-blackprimary flex flex-col items-center gap-2 p-4">
      <div className="w-full h-2/3 relative  border-4">
        <Image
          src={imageUrl}
          fill
          alt={imageAlt}
...
const Organisators = () => {
  return (
    <div className="p-6 xl:h-screen flex flex-col">
      {" "}
      <h1 className="text-3xl sm:text-5xl text-black pb-6 sm:pb-10">
        ORGANIZATORZY
      </h1>
      <div className="grid grid-cols-1 grid-rows-4 md:grid-cols-2 place-content-start md:grid-rows-2 xl:flex flex-row justify-between w-full gap-6 gap-x-6  xl:h-3/4">
        <Organisator
        ...
        <Organisator
          ...
          imageUrl="/organisators/kasia.jpg"
    ...
    <section className="pt-[10vh] bg-purpleprimary  ">
      ...
      <div className="p-6 xl:h-screen">
        ...
        <div className="sm:h-3/4 w-full drop-shadow-big bg-white border-4 border-blackprimary flex flex-col sm:flex-row justify-between gap-6 p-6 text-black">
          ...
          <div className="relative hidden sm:block border-4 w-1/2 flex-grow border-black">
            <Image
